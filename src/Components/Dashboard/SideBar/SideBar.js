import { faCalendar, faCog, faFileAlt, faGripHorizontal, faSignOutAlt, faUserPlus, faUsers } from '@fortawesome/free-solid-svg-icons';
...
const Sidebar = () => {
    ...
    useEffect(() => {
        fetch('https://serene-citadel-65750.herokuapp.com/isDoctor', {
            method: 'POST',
